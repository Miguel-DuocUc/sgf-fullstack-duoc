...
public class LogisticsController {
    ...
    @PostMapping
    public ResponseEntity<PuestoResponseDto> crear(@RequestBody PuestoRequestDto request) {
    ...
    @PutMapping("/{id}")
    public ResponseEntity<PuestoResponseDto> actualizar(@PathVariable Long id, @RequestBody PuestoRequestDto request) {
